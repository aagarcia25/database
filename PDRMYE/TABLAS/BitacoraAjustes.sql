...
-- Volcando estructura para tabla PDRMYE.BitacoraAjustes
DROP TABLE IF EXISTS `BitacoraAjustes`;
CREATE TABLE IF NOT EXISTS `BitacoraAjustes` (
  ...
  `IdRegistro` char(36) NOT NULL DEFAULT '',
  `Aplicado` int(1) NOT NULL DEFAULT 0,
  `Origen` varchar(1000) DEFAULT NULL,
