...
CREATE TABLE IF NOT EXISTS `CalculoGarantia` (
  ...
  `Garantia` decimal(30,2) DEFAULT NULL,
  `idMunicipio` char(36) NOT NULL,
  `Distribucion` decimal(20,20) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `FK1_CG_IdMunicipio` (`idMunicipio`),
  CONSTRAINT `FK1_CG_IdMunicipio` FOREIGN KEY (`idMunicipio`) REFERENCES `Municipios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
