...
-- Volcando datos para la tabla PDRMYE.ORGCfdi: ~0 rows (aproximadamente)
DELETE FROM `ORGCfdi`;
/*!40000 ALTER TABLE `ORGCfdi` DISABLE KEYS */;
/*!40000 ALTER TABLE `ORGCfdi` ENABLE KEYS */;
