...
DROP TABLE IF EXISTS `TblAnticiposParticipaciones`;
...
-- Volcando datos para la tabla PDRMYE.TblAnticiposParticipaciones: ~0 rows (aproximadamente)
DELETE FROM `TblAnticiposParticipaciones`;
/*!40000 ALTER TABLE `TblAnticiposParticipaciones` DISABLE KEYS */;
/*!40000 ALTER TABLE `TblAnticiposParticipaciones` ENABLE KEYS */;
